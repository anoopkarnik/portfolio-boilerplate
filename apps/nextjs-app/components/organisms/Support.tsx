...
import PortfolioAssistantChatbot from "./PortfolioAssistantChatbot";
          ...
          {!activePanel && (
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-center text-xs">Send me a message</div>
              </div>
              ...
              >
                ...
                <div className="text-center text-xs">Join my newsletter</div>
              </div>
              ...
              >
                ...
                <div className="text-center text-xs">Portfolio Assistant</div>
              </div>
            </div>
          )}
